const apiUrl = 'https://script.google.com/macros/s/AKfycbzHS54qQceANe-kMfw4wY6wrKjOqdIRzQufU1KZaOa2KF76XNpVhPZCi5UZesWArDQV-w/exec?local=2';
...
if(!requestPresentes){
  loading('ocultar');
  mostrarAlerta('Nenhum dado encontrado', 400)
  return};
